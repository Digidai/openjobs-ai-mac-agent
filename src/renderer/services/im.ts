...
class IMService {
  ...
  isAnyConnected(): boolean {
    ...
    return status.dingtalk.connected || status.feishu.connected || status.telegram.connected || status.discord.connected || status.nim.connected || status.wecom.connected;
  }
}
