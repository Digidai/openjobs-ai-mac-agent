...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkWorkingDirectoryHint: 'OpenJobs AI 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 OpenJobs AI 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 OpenJobs AI 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'OpenJobs AI 使用模型设置中的当前模型与提供商配置。',
    ...
    coworkPermissionDescription: 'OpenJobs AI 请求执行以下操作',
    coworkToolName: '工具名称',
    ...
    updateInstallTimeout: '安装超时，请重试或手动安装。',
    updateRestartWarning: '当前有任务正在运行，重启可能导致数据丢失。确定继续？',
    updateDefaultChangelog: '此更新包含性能改进和问题修复。',
    updateReadyToInstall: '可安装',
    updateRetry: '重试',
    checkForUpdate: '检查更新',
    updateChecking: '检查中...',
  ...
  en: {
    ...
    coworkSettings: 'OpenJobs AI Settings',
    ...
    coworkWorkingDirectoryHint: 'OpenJobs AI will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for OpenJobs AI...',
    coworkSystemPromptHint: 'Optional system prompt to customize OpenJobs AI\'s behavior',
    ...
    coworkModelSettingsHint: 'OpenJobs AI uses the current model and provider configuration from Model Settings.',
    ...
    coworkPermissionDescription: 'OpenJobs AI is requesting to perform the following action',
    ...
    updateInstallTimeout: 'Installation timed out. Please retry or install manually.',
    updateRestartWarning: 'A task is currently running. Restarting may cause data loss. Continue?',
    updateDefaultChangelog: 'This update includes improvements and bug fixes.',
