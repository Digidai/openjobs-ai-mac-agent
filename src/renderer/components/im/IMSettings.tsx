...
const IMSettings: React.FC = () => {
  ...
  const handleConnectivityTest = async (platform: IMPlatform) => {
    ...
    // The main process testGateway → runAuthProbe will use stateless HTTP calls,
    // so no historical messages are ingested and the main gateway state is never touched.
