 ...
 *
 * Log file locations:
 *   macOS:   ~/Library/Logs/OpenJobs AI/main.log
 *   Windows: %USERPROFILE%\AppData\Roaming\OpenJobs AI\logs\main.log
 *   Linux:   ~/.config/OpenJobs AI/logs/main.log
 */
...
export function initLogger(): void {
  ...
  // Log startup marker
  log.info('='.repeat(60));
  log.info(`OpenJobs AI started (${process.platform} ${process.arch})`);
  log.info('='.repeat(60));
}
