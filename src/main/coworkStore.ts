...
const getDefaultWorkingDirectory = (): string => {
  return path.join(os.homedir(), 'openjobsai', 'project');
};

const TASK_WORKSPACE_CONTAINER_DIR = '.openjobsai-tasks';
...
export class CoworkStore {
  ...
  getSession(id: string): CoworkSession | null {
    ...
    return {
      ...
      executionMode: (row.execution_mode as CoworkExecutionMode) || 'auto',
      activeSkillIds,
      messages,
  ...
  getConfig(): CoworkConfig {
    ...
    return {
      ...
      executionMode: normalizedExecutionMode || 'auto',
