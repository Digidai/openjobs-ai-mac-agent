...
This guide walks through testing the entire Web Search Skill integration with OpenJobs AI.

## Prerequisites

1. OpenJobs AI built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with OpenJobs AI.

**Steps:**

1. Start OpenJobs AI in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of OpenJobs AI launch.
...
1. Open a terminal while OpenJobs AI is running
...
**Objective:** Verify graceful shutdown of services when OpenJobs AI quits.

**Steps:**

1. With OpenJobs AI running and searches completed, quit the application
...
1. Start OpenJobs AI (ensure headless is false in config)
...
- ✅ Server auto-starts with OpenJobs AI
