...
Real-time web search capability for OpenJobs AI using Playwright-controlled browser automation.

## Overview

The Web Search Skill enables OpenJobs AI to perform live web searches using Google and Bing, with automatic fallback when one provider is unavailable. The skill uses Playwright to control a local Chrome browser instance, making all operations transparent and observable.
...
This skill is part of the OpenJobs AI project. For issues or suggestions:
